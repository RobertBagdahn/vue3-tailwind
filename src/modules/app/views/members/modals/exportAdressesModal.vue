<template>
  <ModalWithSlot :is-open="isOpen" @close-modal="closeModal">
    <DialogTitle as="h3" class="font-h2"> Adressen Export </DialogTitle>

    <DialogDescription class="font-p">
      Wir erstellen gerade deine angefragte PDF mit den ausgewählten
      Nutzer_innen
    </DialogDescription>
    ...
    <div class="flex flex-row gap-4 justify-center mt-8">
      ...
      <PrimaryButton :target="() => handleConfirmation()"
        >Alles klar</PrimaryButton
      >
    </div>
  </ModalWithSlot>
</template>
